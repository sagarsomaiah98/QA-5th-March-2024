	...
	public static void main(String[] args) throws InterruptedException {
     ...
     Thread.sleep(3000);
       ...
       Thread.sleep(3000);
        ...
        driver.findElement(By.id("currentAddress")).sendKeys(Keys.chord(Keys.CONTROL, "a"));//ctrl+A
        Thread.sleep(3000);
       
       
        driver.findElement(By.id("currentAddress")).sendKeys(Keys.chord(Keys.CONTROL, "c"));//ctrl+c
